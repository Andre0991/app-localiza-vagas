...
public class DisponibilidadeServices {
    ...
    public static void addDisponibilidade(DisponibilidadeCalcada disponibilidadeCalcada, final Context ctx, final VolleyJsonOBJCallback callback) {
        String url = API_ADDRESS + API_VERSION + "/horario";
        JSONObject jsonObj = new JSONObject();
        try {
            String str = new Gson().toJson(disponibilidadeCalcada);
